...
-(BOOL)handleHttpOK:(NSMutableData *)data {
    ...
    if ([resultsd count]>0) {
        ...
        [self.delegate FBLoginInvocationDidFinish:self withResults:[self.rerg objectForKey:@"success"] withMessages:[self.rerg objectForKey:@"error"] withError:error];
...
-(BOOL)handleHttpError:(NSInteger)code {
	[self.delegate FBLoginInvocationDidFinish:self
                                withResults:Nil
                               withMessages:Nil
