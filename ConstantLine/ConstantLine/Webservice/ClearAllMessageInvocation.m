...
@implementation ClearAllMessageInvocation

@synthesize user_id;

-(void)invoke {
	NSString *a= @"clear_all_message";
...
-(BOOL)handleHttpOK:(NSMutableData *)data {
    ...
    [self.delegate ClearAllMessageInvocationDidFinish:self withResults:[dic objectForKey:@"success"] withMessages:[dic objectForKey:@"error"]  withError:error];
...
-(BOOL)handleHttpError:(NSInteger)code {
    ...
    [self.delegate ClearAllMessageInvocationDidFinish:self 
                                         withResults:Nil
                                        withMessages:Nil
