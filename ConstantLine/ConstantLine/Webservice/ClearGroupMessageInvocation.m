...
@implementation ClearGroupMessageInvocation

@synthesize user_id,group_id;

-(void)invoke {
	NSString *a= @"clearAllGroupMessage";
...
-(BOOL)handleHttpOK:(NSMutableData *)data {
    ...
    [self.delegate ClearGroupMessageInvocationDidFinish:self withResults:[dic objectForKey:@"success"] withMessages:[dic objectForKey:@"error"]  withError:error];
...
-(BOOL)handleHttpError:(NSInteger)code {
    ...
    [self.delegate ClearGroupMessageInvocationDidFinish:self 
                                          withResults:Nil
                                         withMessages:Nil
