//
//  ClearIndivisualChatInvocation.m
//  ConstantLine
//
...
@implementation ClearIndivisualChatInvocation

@synthesize user_id;
@synthesize friend_id;

-(void)invoke {
	NSString *a= @"clear_individual_message";
...
-(BOOL)handleHttpOK:(NSMutableData *)data {
    ...
    [self.delegate ClearIndivisualChatInvocationDidFinish:self withResults:[dic objectForKey:@"success"] withMessages:[dic objectForKey:@"error"]  withError:error];
...
-(BOOL)handleHttpError:(NSInteger)code {
    ...
    [self.delegate ClearIndivisualChatInvocationDidFinish:self
                                          withResults:Nil
                                         withMessages:Nil
