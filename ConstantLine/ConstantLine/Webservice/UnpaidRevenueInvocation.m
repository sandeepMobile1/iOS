...
@implementation UnpaidRevenueInvocation

@synthesize user_id;

-(void)invoke {
	NSString *a= @"unPaidAmount";
...
-(BOOL)handleHttpOK:(NSMutableData *)data {
    ...
    [self.delegate UnpaidRevenueInvocationDidFinish:self withResults:resultsd withMessages:@"" withError:error];
...
-(BOOL)handleHttpError:(NSInteger)code {
    ...
    [self.delegate UnpaidRevenueInvocationDidFinish:self
                                        withResults:Nil
                                       withMessages:Nil
